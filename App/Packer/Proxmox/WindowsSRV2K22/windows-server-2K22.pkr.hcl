...
source "proxmox-iso" "windows-server-2k22" {
    ...
    node = "pve-srv-01"
    # vm_id = "100"
    vm_name = "windows-server-2k22"
    template_description = "Windows Server 2022 Datacenter Edition"
    ...
    iso_url = "https://go.microsoft.com/fwlink/p/?LinkID=2195280&clcid=0x407&culture=de-de&country=DE"
